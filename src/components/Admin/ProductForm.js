...
function ProductForm() {
  ...
  useEffect(() => {
    if (selectedProduct && params.id) {
      ...
      setValue("highlight1", selectedProduct.highlights1);
      setValue("highlight2", selectedProduct.highlights2);
      setValue("highlight3", selectedProduct.highlights3);
      setValue("highlight4", selectedProduct.highlights4);
        // setValue(
        //   "sizes",
